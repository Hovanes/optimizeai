...
Tact = {}
-- Sleepers
Tact[1386] = {"Sleeper", BEHA_attack, WITH_full_power, 5, 0}
Tact[1378] = {"Demon Pungus", BEHA_react, WITH_two_skills, 5, 0}
Tact[1372] = {"Goat", BEHA_react, WITH_one_skill, 5, 0}
-- Glast Heim Churchyard
Tact[1197] = {"Zombie Prisoner", BEHA_attack, WITH_full_power, 5, 0}
Tact[1192] = {"Wraith", BEHA_attack, WITH_full_power, 5, 0}
Tact[1196] = {"Skeleton Prisoner", BEHA_attack, WITH_two_skills, 5, 0}
Tact[1015] = {"Zombie", BEHA_attack_1st, WITH_no_skill, 5, 0}
Tact[1117] = {"Evil Druid", BEHA_attack, WITH_full_power, 5, 0}
-- New data
Tact[1145] = {"Martin", BEHA_attack, WITH_one_skill, 5, 0}
Tact[1261] = {"Wild Rose", BEHA_react, WITH_full_power, 5, 0}
-- Orc Dungeon (lvl 50+ Settings)
Tact[1042] = {"Steel Chonchon", BEHA_attack_last, WITH_no_skill, 5, 0}
Tact[1153] = {"Orc Zombie", BEHA_attack, WITH_one_skill, 5, 0}
Tact[1189] = {"Orc Archer", BEHA_attack_1st, WITH_full_power, 5, 0}
Tact[1177] = {"Zenorc", BEHA_attack, WITH_full_power, 5, 0}
Tact[1152] = {"Orc Skeleton", BEHA_attack, WITH_one_skill, 5, 0}
Tact[1111] = {"Drainliar", BEHA_attack, WITH_no_skill, 1, 0}
...
-- General cautions
Tact[1035] = {"Hunter Fly", BEHA_react_1st, WITH_full_power, 5, 0}
Tact[1191] = {"Mimic", BEHA_react, WITH_two_skills, 5, 0}
-- New data
-- End Tact
